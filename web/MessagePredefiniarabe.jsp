...
<form class="formular" action="EnvoiMsgPredifinarabe.jsp" >
...
<div id="controle_decompte" name="controle_decompte" class="decompte" style="padding:0px 180px; "></div>
			<script language="Javascript" type="text/javascript">
			LimiterTextArea('message', 134, 'controle_decompte');
		    </script>

<br/>

 <div class="demo">
     <a href="javascript:void(0);" onclick="msgwin_datagridArabe.show();" class="submit_dgrid_pre" style="border:none; "><u>Consulter les messages</u></a>

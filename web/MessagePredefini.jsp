...
<div id="page-middle">
  <div id="page-content">
    	...
    	<div id="page-title">
    	<h1>MESSAGE PREDEFINI </h1>
        </div><!--PAGE TITLE ENDS-->


<form class="formular" action="EnvoiMsgPredifin.jsp" >

    <label>
         <span>Nom: </span>
         <input name="nom_msg" id="nom_msg" value=""  class="validate[required,length[0,100]] text-input"/><br /><br />
    </label>
   ...
   <label>
       <span>Message: </span>
   <textarea  name="message" id="message"  onDrop="return false" onPaste="return false" class="validate[required,length[3,320]] " rows="5" cols="30"   ></textarea>
...
<br/>
 ...
 <div class="demo">
     <button type="submit" style="float:right;">Enregistrer</button><br>
   <a href="javascript:void(0);" onclick="msgwin_datagrid.show();" class="submit_dgrid_pre" style="border:none; "><u>Consulter les messages</u></a>

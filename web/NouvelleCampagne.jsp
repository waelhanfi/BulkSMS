...
{
document.liste.action = "enregistrementNouvelleCampagne.jsp";
...
document.liste.action = "EnvoiCampagneAdmin.jsp";
...
function NbCarRestant(moncontroletexte, nbcar)
{
 ...
 <%
	...
	Gerer_Date gerer = new Gerer_Date();
	  ...
	  String date = gerer.getJour2();
        String heure = gerer.Get_Heure();
        String espace = " ";
	String date_debut=date +espace+heure;
...
<script type="text/javascript" src="js/grid/choixliste.js"></script>
<script type="text/javascript" src="js/grid/msgpredefini.js"></script>

<!--Datagrid-->

<div id="madiv_datagrid"></div>
...
<div id="bg-container">
	...
	<ul>
		...
		<li><a href="NouvelleCampagne.jsp">Nouvelle campagne</a>	
		</li><li><a href="NouvelleCampagneArabe.jsp">Nouvelle campagne Arabe</a></li>
...
<form id="liste" name ="liste" class="formular"  action="enregistrement_nouvelle_campagne.jsp">
<fieldset>

<label>
    <span> Nom: </span>
    <input id="nom_liste" name="nom_liste" class="validate[required,length[0,100]] text-input" type="text" />
</label>


<label>
    <span> liste:</span><br/>
    <input readonly="readonly"  id="listenvoi"  name="listenvoi" class="validate[required] text-input" />
    <input type="hidden"  name="idListe"  value="">

</label>

<div class="demo" >
    <a href="javascript:void(0);" class="submit_dgrid_liste" onclick="win_datagrid.show();" style="border:none; float: right;  margin-top: 0px;"><u>Choisir une liste</u></a>
</div>
...
<label>
    <span>Message: </span>
    <textarea id="resizable"  onDrop="return false" onPaste="return false" class="validate[required,length[3,320]] " rows="5" cols="30"  name="msg"  ></textarea>

</label>


<div id="controle_decompte" name="controle_decompte" class="decompte" style="margin-left:180px; margin-top: 0px;" ></div>
			<script language="Javascript" type="text/javascript">
			LimiterTextArea('resizable', 320, 'controle_decompte');
		    </script>


<div class="demo">
    <a href="javascript:void(0);" class="submit_dgrid_msg" onclick="msgwin_datagrid.show();" style="border:none;"><u>Choisir un message prédifini</u></a>
</div>
...
<label>
    <span>Spécifiez la date et l'heure d'envoi:</span>
    <input type="text" name="date_envoi" id="date_envoi"  value="<%=date_debut%>" class="validate[required] text-input" />
...
<div class="demo">
 <div align="center" style="margin-bottom:3px;margin-top:3px; ">
     <button type="submit"  onclick="enregistrer()" >Enregistrer</button>
   <button type="submit" onclick="envoyer()"  style="margin-left:5px; ">Envoyer</button>
 </div>
</div><!-- End demo -->

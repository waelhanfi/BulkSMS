...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Afficher _MENU_ entrées",sZeroRecords:"Aucun message correspondant à votre recherche n'a été trouvé",sInfo:"Affichage _START_ à _END_ de _TOTAL_ entrées",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Recherche:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"}};

...
<div id="page-middle">
  <div id="page-content">
    	...
    	<div id="page-title">
    	<h1>CONSOLE DE GET WIRELESS </h1>
        </div><!--PAGE TITLE ENDS-->
<br/><br/><br/><br/>
<div id="featured">
 <p class="welcome-text">Bienvenue sur l'interface SMS CONSOLE de GET WIRELESS.Pour configurer votre campagne, cliquez sur le bouton <br>« <a href="NouvelleCampagne.jsp"><u> Nouvelle campagne</u></a> »<br><br>dans le menu de gauche.
Pour un envoi vers une liste restreinte de numéros,cliquez sur le bouton «<a href="MessageRapide.jsp"> <u>lancement rapide</u></a> »
    Pour toute<br> question rendez-vous la rubrique<a href="Aide.jsp"><u> Aide</u></a>,<br> en haut droite de votre écran.
 </p><!--FEATURED IMAGE ENDS-->
</div><!--FEATURED ENDS-->

...
{
document.liste.action = "enregistrementNouvelleCampagneArabe.jsp";
...
document.liste.action = "EnvoiCampagneAdminArabe.jsp";
...
<script type="text/javascript" src="js/grid/msgpredefiniarabe.js"></script>
...
<form id="liste" name ="liste" class="formular"  action="enregistrement_nouvelle_campagne_arabe.jsp">
<fieldset>
...
<label>
    <span>Message: </span>
    <textarea id="resizable" class="validate[required,length[3,134]] " rows="5" cols="30"  name="msg"  ></textarea>
...
<div id="controle_decompte" name="controle_decompte" class="decompte" style="margin-left:180px; margin-top: 0px;" ></div>
			<script language="Javascript" type="text/javascript">
			LimiterTextArea('resizable', 134, 'controle_decompte');
		    </script>


<div class="demo">
    <a href="javascript:void(0);" class="submit_dgrid_msg" onclick="msgwin_datagridArabe.show();" style="border:none;"><u>Choisir un message prédifini</u></a>
</div>

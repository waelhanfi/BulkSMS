...
<div id="page-wrap">
        ...
        <ul class="sub_menu">
        			...
        			<li><a href="listeparam.jsp">liste param.</a></li> 
...
<div class="demo">
  ...
  <label>
	<span>Nom: </span>
    <input id="nom_list_param" name="nom_list_param" class="validate[required,length[0,100]] text-input" /><br/>

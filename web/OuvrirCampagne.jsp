...
%>
      ...
      <script language="javascript" src="js/paging-grid.js"></script>
...
<%
	...
	//charger les attribus de l'abonné
	 Sql sql = new Sql(Sql.ADR_IP, Sql.NOM_BASE, Sql.LOGIN, Sql.PWD);
        ...
        List  listes = dao.getAllRegistred(sql, user);
        sql.Fermer_Cnn();
%>
...
<div id="page-middle">
   ...
   <!--DataGrid-->
<br/><br/><br/><br/><br/><br/>
<div id="paging-grid" style="margin-left:20px"></div>
<%--<div id="EditorPanel" style="margin-left:70px"></div>--%>

...
<br/><br/><br/>
        <div style="margin-left:15px; padding: 10px; position: absolute;font-weight:300; ">Veuillez saisir un numéro pour l'ajouter au Blacklist:

        </div>

<div >

 <form class="formular" action="SucceBlackliste.jsp"  >
  ...
  <input name="numblack" id="numblack" value=""  style="padding:3px;"  maxlength="8" class="validate[required,custom[onlyNumber]] text-input" />
  </label>
  <button type="submit" style="float: right;">Ajouter</button>
  <br/><br/><br/>
</div>
 </div><!-- End demo -->
    ...
    <br/>
 <div style="margin-left:15px; padding: 10px; position: absolute;  font-weight:300; ">Veuillez choisir une liste pour l'ajouter au Blacklist:

        </div>
<form name="Upload" action="UploadBlacklist" method="post" enctype="multipart/form-data" class="formular">
<div class="ui-widget">
<div class="demo">
...
<!--<form class="styl_form" >
 <div class="left-nav">
<div class="demo">
     <button style="height:24px; border:none; border-bottom:none; top:3px; ">Afficher les num&eacute;ros "Blackliste"</button>
